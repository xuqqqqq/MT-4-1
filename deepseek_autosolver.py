...
def build_generation_prompt(
    ...
    prompt_parts = [
        ...
        "Hard line budget: the complete solver must be under 560 physical lines.",
        "Any solution that is truncated, unfinished, or over 560 lines is invalid.",
...
def build_strategy_reflection_prompt(
    ...
    prompt_parts = [
        ...
        "- Earlier non-hardcoded DeepSeek solver on large_seed301 reached about 678.40; current retained best is 666.2408381991042.",
